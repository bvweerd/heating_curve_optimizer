# custom_components/dynamic_energy_heatpump_optimizer/services.py
...
async def async_register_services(hass: HomeAssistant) -> None:
    """Register custom services for Dynamic Energy Heatpump Optimizer."""
    ...
    _LOGGER.debug("Dynamic Energy Heatpump Optimizer services registered.")
...
async def async_unregister_services(hass: HomeAssistant) -> None:
    ...
    _LOGGER.debug("Dynamic Energy Heatpump Optimizer services unregistered.")
